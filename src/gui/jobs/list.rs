...
use super::super::animations::{list_item_background, pulse_indicator};
use super::super::app::{ACCENT_PURPLE, BG_HIGHLIGHT, BG_SELECTED, TEXT_DIM, TEXT_MUTED, TEXT_PRIMARY};
        ...
        ScrollArea::vertical()
            ...
            .show(ui, |ui| {
                ...
                for job in &sorted_jobs {
                    ...
                    // Reserve space for the job item
                        ...
                        let response = egui::Frame::NONE
                            ...
                            .show(ui, |ui| {
                                ui.horizontal(|ui| {
                                    ...
                                    match job.status {
                                        JobStatus::Running => {
                                            // Animated pulse indicator for running jobs
                                            pulse_indicator(ui, status_col, 14.0);
                                        }
                                        JobStatus::Queued => {
                    ...
                    let is_hovered = item_response.response.hovered();
